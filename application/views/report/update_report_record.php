...
<!-- Requested for Change Display Section -->
<div class="card shadow-lg p-4 mb-4">
  <h4 class="text-center mb-4 text-primary">Requested for Change</h4>
  <div class="row g-3">
    <div class="col-md-6">
      <label class="form-label">Field to Change</label>
      <input type="text" class="form-control" value="<?= $leads['column_name'] ?? 'N/A' ?>" readonly>
    </div>
    ...
    <div class="col-md-12">
      ...
      <textarea class="form-control" rows="3" readonly><?= $leads['requested_change'] ?? 'N/A' ?></textarea>
    </div>
  </div>
</div>

<form action="<?= site_url('ChangeRequest/updateLead') ?>" method="post" enctype="multipart/form-data">
  ...
  <div class="card shadow-lg p-4 mb-4">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-4">
          ...
          <input type="hidden" name="user_id" value="<?= $leads['user_id'] ?>">
          <input type="hidden" name="report_id" value="<?= $leads['report_id'] ?>">
          <input type="hidden" name="change_request_id" value="<?= $leads['change_request_id'] ?>">
          <input type="hidden" name="user_id" value="<?= $leads['user_id'] ?>">
     ...
     <div class="col-md-4 amount">
        <label for="final_amount" class="form-label">Generate This Lead</label>
      ...
      <div class="col-md-4 amount">
        ...
        <input type="text" name="u_name" class="form-control" placeholder="Enter Final Amount" value="<?= $leads['role']??'' ?>" readonly>
      </div>
      
      <div class="col-md-4 amount">
        <label for="final_amount" class="form-label">Uploaded Updared Report</label>
